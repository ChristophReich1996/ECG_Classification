\begin{tabular}{>{\centering\arraybackslash}p{0.205\columnwidth}>{\centering\arraybackslash}p{0.15\columnwidth}>{\centering\arraybackslash}p{0.2\columnwidth}>{\raggedright\arraybackslash}p{0.1\columnwidth}>{\raggedright\arraybackslash}p{0.1\columnwidth}}
    \hline
